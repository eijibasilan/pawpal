...
const daycarePackages = [
    ...
    },
    {
        ...
        description: 'FULL DAY, MEAL, GROOMING & PLAY TIME',
        price: '1000'
    }
];
...
const stayPackages = [
    {
        title: 'PREMIUM STAY',
        description: 'COZY CONDO STAY, FRESH WATER, 2 MEALS, PLAYTIME',
        prices: {
            small: '500',
            large: '650'
        }
    ...
    {
        title: 'VIP STAY',
        description: 'STANDARD STAY, LARGER CONDO, SOFT BED, MEAL UPGRADE, DAILY PLAYTIME',
        prices: {
            small: '900',
            large: '1100'
        }
...
<template>
    <div class="container mx-auto px-4 py-8">
        <h1 class="mb-8 text-3xl font-bold text-center">Cat Hotel Services</h1>
